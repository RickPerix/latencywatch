...
public class JoinVersionListener implements Listener {
    ...
    private boolean versionAnnounced = false;
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (savedVersion == null || !currentVersion.equals(savedVersion.trim())) {
            player.sendMessage("§a[LatencyWatch] §fPlugin has been successfully installed! The version currently installed on this server is §e" + currentVersion);
            player.sendMessage("§7Please read the §6README.txt §7file in the plugin folder for more information.");

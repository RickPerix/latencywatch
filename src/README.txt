Manual Update Instructions for config.yml – LatencyWatch Plugin

Purpose:

This guide explains how to manually update the config.yml file
after updating the LatencyWatch plugin, without losing important settings.
...
- On server startup, LatencyWatch will automatically create a fresh config.yml.
